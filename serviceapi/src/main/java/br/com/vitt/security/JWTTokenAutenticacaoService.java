...
import br.com.vitt.ApplicationContextLoad;
...
public class JWTTokenAutenticacaoService {
	...
	/* Tempo de validade do token em milisegundos - atual 2 dias */
	private static final long EXPIRATION_TIME = 172800000;

	/* Uma senha unica para compor a autenticação */
	private static final String SECRET = "Persia3136011030250034761339Lucas";
	...
	public void addAuthentication(HttpServletResponse response, String username) throws IOException {
		...
		String token = TOKEN_PREFIX + " " + JWT; /* Aparência ==== Bearer 6546546489498498489484984849 */

		/* Adiciona o cabeçalho Http */
		response.addHeader(HEADER_STRING, token);/* Aparência ==== Authorization: Bearer 6546546489498498489484984849 */
	...
	public Authentication getAuthentication(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			try {
				response.getOutputStream().println("Seu token esta expirado! Faça login novamente!");
